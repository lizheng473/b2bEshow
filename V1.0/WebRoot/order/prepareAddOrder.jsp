...
<!-- 					<a href="<c:url value='/admin/blog/edit/${view.product.id}'/>">修改</a> -->
			...
			<!-- .post -->
			<s:form action="order!save.html" method="post" cssClass="creat_form clearfix">
			<div>
				...
				<td>
					...
					<p>
							...
							<p>
								<span class="2">请输入购买数量:</span>
								<span class="r">&nbsp; <input name="orderForm.orderquality"
										class="inputtext text-input validate['required']"  style="width: 300px;" maxlength="50"
										type="text" onblur="this.className='inputtext'" 
							...
							<p>
								<span class="2">请输入定制规格:</span>
								<span class="r">&nbsp; <input name="orderForm.ordersize"
										class="inputtext text-input validate['required']"  style="width: 300px;" maxlength="50"
										type="text" onblur="this.className='inputtext'" 
							...
							<p>
								<span class="2">请输入收货人名称:</span>
								<span class="r">&nbsp; <input name="orderForm.customername"
										class="inputtext text-input validate['required']"  style="width: 300px;" maxlength="50"
										type="text" onblur="this.className='inputtext'" 
							...
							<p>
								<span class="2">请输入收货人电话:&nbsp;</span>
								<span class="r">&nbsp; <input name="orderForm.customertel"
										class="inputtext text-input validate['required']"  style="width: 300px;" maxlength="50"
										type="text" onblur="this.className='inputtext'" 
							...
							<p>
								<span class="2">请输入收货地址:&nbsp;&nbsp;&nbsp;</span>
								<span class="r">&nbsp; <input name="orderForm.customeraddress"
										class="inputtext text-input validate['required']"  style="width: 300px;" maxlength="50"
										type="text" onblur="this.className='inputtext'" 

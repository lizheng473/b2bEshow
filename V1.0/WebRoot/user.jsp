	...
	<body>
		<div id="page-wrapper">
			...
			<div id="tldemo" style="display: none; position: absolute;">
				<img src="<c:url value='/images/index/tl_demo.gif'/>" />
			</div>
			<div class="s_top">
				<div class="s_logo">
					<a href="<c:url value='/'/>"><img
							src="<c:url value='/images/indexlogo.gif'/>" border="0" /> </a>
				</div>
				<div class="s_nav">
					<a href="<c:url value='/blog'/>" class="sub"><img
							src="<c:url value='/images/menu_01.jpg'/>" alt="日志" width="120"
							height="67" border="0" /> </a>
					<a href="<c:url value='/album'/>" class="sub"><img
							src="<c:url value='/images/menu_02.jpg'/>" alt="相册" width="109"
							height="67" border="0" /> </a>
					<a href="<c:url value='/club'/>" class="sub"><img
							src="<c:url value='/images/menu_03.jpg'/>" alt="咨询社区" width="110"
							height="67" border="0" /> </a>
					<a href="<c:url value='/service'/>" class="sub"><img
							src="<c:url value='/images/menu_04.jpg'/>" alt="服务项目" width="116"
							height="67" border="0" /> </a>
					<a href="<c:url value='/user'/>" class="sub"><img
							src="<c:url value='/images/menu5_05.jpg'/>" alt="员工档案"
							width="119" height="67" border="0" /> </a>
				</div>
			</div>
			<div class="sc_mian">
				<div class="sc_left">
